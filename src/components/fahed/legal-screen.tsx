...
const faqItems: FaqItem[] = [
  ...
  },
  {
    ...
    answer: 'يمكنك التواصل مع فريق الدعم الفني بعدة طرق: من خلال قسم الدعم والمساعدة داخل التطبيق حيث يمكنك فتح تذكرة دعم جديدة والرد عليها مباشرة. أيضاً يمكنك التواصل عبر البريد الإلكتروني المخصص للدعم support@south-wallet.com. فريق الدعم متاح للاستجابة لاستفساراتك وحل مشاكلك في أسرع وقت ممكن، عادةً خلال ساعات قليلة. نحرص على تقديم خدمة عملاء متميزة على مدار الساعة لمساعدتك في أي وقت.',
  },
  {
...
• البريد الإلكتروني: support@south-wallet.com
• الموقع الإلكتروني: www.south-wallet.com
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3 p-3 rounded-xl" style={{ background: isDark ? 'rgba(255,255,255,0.04)' : 'rgba(0,0,0,0.03)' }}>
                    ...
                    <div>
                      ...
                      <p className="text-xs font-bold" style={{ color: isDark ? '#CCC' : '#444' }} dir="ltr">support@south-wallet.com</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-3 rounded-xl" style={{ background: isDark ? 'rgba(255,255,255,0.04)' : 'rgba(0,0,0,0.03)' }}>
                    ...
                    <div>
                      ...
                      <p className="text-xs font-bold" style={{ color: isDark ? '#CCC' : '#444' }} dir="ltr">www.south-wallet.com</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-3 rounded-xl" style={{ background: isDark ? 'rgba(255,255,255,0.04)' : 'rgba(0,0,0,0.03)' }}>
